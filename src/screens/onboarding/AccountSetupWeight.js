...
export default function AccountSetupWeight({ navigation }) {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      Alert.alert("Error", "We couldn't save your weight. Please try again.");
    } finally {
      setLoading(false);
    }
  };
...
const styles = StyleSheet.create({
  ...
  valueBox: { backgroundColor: '#F3F4FF', paddingHorizontal: 40, paddingVertical: 15, borderRadius: 20 },
