    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Your natural reversal plan is ready. Let's start your journey to better health.
        </Text>
        ...
        <View style={styles.predictionCard}>
          ...
          <Text style={styles.timeframeText}>Projected 4-Month HbA1c Improvement</Text>
          ...
          <View style={styles.chartWrapper}>
            <Svg height={chartHeight} width={chartWidth}>
              ...
              />
              <Path
                d={`M 0 30 Q ${chartWidth / 2} 40, ${chartWidth} 110 L ${chartWidth} ${chartHeight} L 0 ${chartHeight} Z`}
                fill="url(#grad)"
              />
              <Circle cx="0" cy="30" r="6" fill="#FFFFFF" />
              <Circle cx={chartWidth} cy="110" r="6" fill="#82B1FF" stroke="#FFF" strokeWidth="2" />
            </Svg>
        ...
        <View style={styles.detailsContainer}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Daily Natural Management Plan</Text>
          </View>

          {/* Row 1: Nutrition Focus */}
          <View style={styles.row}>
            <View style={styles.rowLabelContainer}>
              <MaterialCommunityIcons name="food-apple" size={20} color="rgba(255,255,255,0.7)" />
          ...
          <View style={styles.row}>
            <View style={styles.rowLabelContainer}>
              <FontAwesome5 name="walking" size={18} color="rgba(255,255,255,0.7)" />
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 30, fontWeight: '800', color: '#825CFF', textAlign: 'center', marginBottom: 12 },
  subtitle: { fontSize: 15, color: '#6B7280', textAlign: 'center', lineHeight: 22, marginBottom: 30 },
  predictionCard: { backgroundColor: '#825CFF', borderRadius: 32, padding: 24, marginBottom: 20, elevation: 8, shadowColor: '#825CFF', shadowOpacity: 0.3, shadowRadius: 10, shadowOffset: { height: 5, width: 0 } },
  badgeContainer: { alignItems: 'center', marginBottom: 15 },
  badge: { backgroundColor: '#FFFFFF', paddingHorizontal: 20, paddingVertical: 6, borderRadius: 20 },
  badgeText: { color: '#825CFF', fontWeight: '800', fontSize: 14, textTransform: 'uppercase' },
  timeframeText: { color: '#FFFFFF', textAlign: 'center', fontSize: 13, opacity: 0.9, marginBottom: 20, fontWeight: '500' },
  chartWrapper: { height: 180 },
  chartLabels: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 15 },
  labelBox: { backgroundColor: 'rgba(255,255,255,0.2)', padding: 10, borderRadius: 12, minWidth: 100 },
  labelText: { color: '#FFF', fontSize: 11, opacity: 0.8, marginBottom: 2 },
  labelValue: { color: '#FFF', fontSize: 14, fontWeight: '700' },
  detailsContainer: { backgroundColor: '#825CFF', borderRadius: 32, padding: 20, paddingBottom: 35 },
  sectionHeader: { backgroundColor: 'rgba(255,255,255,0.2)', paddingVertical: 12, borderRadius: 16, marginBottom: 25, alignItems: 'center' },
  sectionTitle: { color: '#FFFFFF', fontWeight: '700', fontSize: 15 },
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 22, paddingHorizontal: 5 },
  rowLabelContainer: { flexDirection: 'row', alignItems: 'center' },
  rowLabel: { color: 'rgba(255,255,255,0.8)', fontSize: 15, marginLeft: 10, fontWeight: '500' },
  rowValue: { color: '#FFFFFF', fontSize: 15, fontWeight: '700' },
  footer: { position: 'absolute', bottom: 0, width: '100%', paddingHorizontal: 25, paddingBottom: 40, backgroundColor: 'rgba(255,255,255,0.9)' },
  startButton: { backgroundColor: '#111827', height: 65, borderRadius: 35, justifyContent: 'center', alignItems: 'center', flexDirection: 'row' },
