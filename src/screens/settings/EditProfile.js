    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleSave} disabled={loading}>
          <Text style={[styles.saveBtn, loading && { opacity: 0.6 }]}>Save</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.avatarSection}>
          <View style={styles.avatar}>
            <Text style={styles.avatarText}>{firstName[0] || 'D'}{lastName[0] || 'N'}</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  saveBtn: { color: '#825CFF', fontWeight: '700', fontSize: 16 },
  content: { paddingHorizontal: 20, paddingVertical: 20 },
  avatarSection: { alignItems: 'center', marginBottom: 30 },
  avatar: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#8B5CF6', justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  avatarText: { color: '#FFF', fontSize: 36, fontWeight: '800' },
  uploadBtn: { position: 'absolute', bottom: 0, right: '33%', width: 40, height: 40, borderRadius: 20, backgroundColor: '#111827', justifyContent: 'center', alignItems: 'center' },
