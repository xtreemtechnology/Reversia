...
// ─── Health Score Ring ────────────────────────────────────────────────────────
// (Inline SVG-free version using border trick for RN compat without extra imports)
...
const ResultCard = ({ result, imageUri, onLog, onRetake, logging }) => (
  <View style={resultStyles.card}>
    ...
    <View style={resultStyles.macrosRow}>
      <MacroPill label="Calories" value={result.calories} unit=" kcal" color="#825CFF" iconName="fire" />
...
const resultStyles = StyleSheet.create({
  ...
  status: { fontSize: 10, color: '#825CFF', fontWeight: '800', textTransform: 'uppercase', marginBottom: 2 },
  ...
  logBtn: {
    ...
    backgroundColor: '#111827', justifyContent: 'center',
  },
...
const styles = StyleSheet.create({
  ...
  headerBtnActive: { backgroundColor: '#825CFF' },
