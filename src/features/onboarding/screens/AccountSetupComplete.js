...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 30, fontWeight: '800', color: '#7C3AED', textAlign: 'center', marginBottom: 12 },
  ...
  badgeText: { color: '#7C3AED', fontWeight: '800', fontSize: 14, textTransform: 'uppercase' },
  ...
  detailsContainer: { backgroundColor: '#7C3AED', borderRadius: 32, padding: 20, paddingBottom: 35 },
