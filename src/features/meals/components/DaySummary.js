    ...
    <View style={summaryStyles.card}>
      <View style={summaryStyles.headerRow}>
        <View>
          ...
          <Text style={summaryStyles.sub}>{eatenCals} of {calorieGoal} kcal eaten</Text>
        </View>
      ...
      <View style={summaryStyles.macros}>
        {[
          { label: 'Plan Calories', value: `${totalCals} kcal`, color: '#7C3AED', icon: 'fire' },
...
const summaryStyles = StyleSheet.create({
  card: {
    backgroundColor: '#7C3AED', borderRadius: 24, padding: 20, marginBottom: 14,
    shadowColor: '#000',
  ...
  pctBadge: { backgroundColor: 'rgba(255, 255, 255, 0.15)', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 12 },
  pctText:  { color: '#FFF', fontWeight: '800', fontSize: 14 },
  track: { height: 6, backgroundColor: 'rgba(255, 255, 255, 0.2)', borderRadius: 3, overflow: 'hidden', marginBottom: 16 },
  ...
  macroLabel:{ fontSize: 10, color: 'rgba(255, 255, 255, 0.7)', fontWeight: '600' },
});
