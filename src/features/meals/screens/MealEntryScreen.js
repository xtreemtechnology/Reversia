...
export default function MealEntryScreen({ navigation, route }) {
  ...
  const [selectedMeal, setSelectedMeal] = useState(route?.params?.meal || 'breakfast');
...
const styles = StyleSheet.create({
  ...
  saveBtn: { backgroundColor: '#7C3AED', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12 },
  ...
  activeTag: { backgroundColor: '#7C3AED' },
