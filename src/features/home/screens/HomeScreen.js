...
const SKELETON_STYLES = {
  ...
  actionRow: { flexDirection: "row", gap: 12, marginBottom: 26, marginTop: 18 },
  ...
  planItemRow: { flexDirection: "row", alignItems: "center", marginBottom: 16 },
  progressItem: { marginRight: 12 },
  dateNav: { marginBottom: 18 },
...
const UI_STYLES = {
  ...
  ringScore: { fontSize: 20, fontWeight: "800" },
  ringLabel: { fontSize: 10, fontWeight: "700", marginTop: -2 },
  macroRow: { flexDirection: "row", alignItems: "center", marginBottom: 9 },
  macroLabel: { width: 88, fontSize: 12, fontWeight: "600" },
  macroTrack: {
    flex: 1,
    height: 6,
    borderRadius: 3,
  ...
  cardMiniTitle: { fontSize: 11, fontWeight: "600", marginBottom: 2 },
  cardMiniValue: { fontSize: 17, fontWeight: "800" },
  cardMiniSub: { fontSize: 10, marginTop: 2 },
  cardAction: {
    width: "48%",
    borderRadius: 22,
    padding: 16,
  ...
  cardActionTitle: { fontSize: 14, fontWeight: "700" },
  cardActionDesc: { fontSize: 12, marginTop: 2 },
  cardActionChev: { position: "absolute", top: 14, right: 14 },
  ...
  miniTitle: { fontSize: 11, fontWeight: "600", marginBottom: 2 },
  miniValue: { fontSize: 17, fontWeight: "800" },
  miniSub: { fontSize: 10, marginTop: 2 },
  actionCard: {
    width: "48%",
    borderRadius: 22,
    padding: 16,
  ...
  emptyTrendText: { fontSize: 12, textAlign: "center", lineHeight: 16 },
  ...
  tabStrip: { marginBottom: 18 },
  tabContainer: { paddingHorizontal: 2 },
  screen: { flex: 1 },
  actionRowTop: {
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  progressCard: { borderRadius: 28, padding: 20, marginBottom: 16 },
  planCardWrap: { borderRadius: 28, padding: 20, marginBottom: 24 },
  quickAccessWrap: {
    flexDirection: "row",
    flexWrap: "wrap",
    justifyContent: "space-between",
...
UI_STYLES.headerGreeting = { fontSize: 14 };
UI_STYLES.headerName = { fontSize: 28, fontWeight: "800", marginTop: 2 };
UI_STYLES.largeBtn = {
  width: "48%",
  height: 52,
  borderRadius: 26,
...
UI_STYLES.largeBtnText = { fontSize: 14, fontWeight: "700" };
UI_STYLES.sectionTitle = { fontSize: 18, fontWeight: "800", marginBottom: 14 };
UI_STYLES.sectionSubtitle = { fontSize: 13, lineHeight: 18, marginTop: 4 };
UI_STYLES.aiIcon = {
  width: 46,
  height: 46,
  borderRadius: 15,
...
UI_STYLES.progressTitle = { fontSize: 13 };
UI_STYLES.progressPct = { fontSize: 26, fontWeight: "800", marginTop: 4 };
UI_STYLES.progressSub = { marginTop: 4, fontSize: 13 };
UI_STYLES.progressBar = { height: 6, borderRadius: 3, marginTop: 14 };
UI_STYLES.planTitle = { fontSize: 18, fontWeight: "800", marginBottom: 14 };
