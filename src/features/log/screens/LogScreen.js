...
const getStyles = (colors) =>
  StyleSheet.create({
    ...
    heroCard: {
      flexDirection: "row",
      alignItems: "center",
      backgroundColor: colors.background === "#FFFFFF" ? "#F8FAFF" : "#1B2438",
      borderRadius: 28,
      padding: 20,
      marginBottom: 22,
      elevation: 1,
      borderWidth: 1,
      borderColor: colors.background === "#FFFFFF" ? "#E6E9FF" : "#334155",
    },
    heroIconWrap: {
      width: 56,
      height: 56,
    ...
    heroTextWrap: { flex: 1 },
    heroTitle: { fontSize: 17, fontWeight: "700", color: colors.text, lineHeight: 22 },
    heroText: {
      fontSize: 13,
      lineHeight: 20,
      color: colors.muted,
